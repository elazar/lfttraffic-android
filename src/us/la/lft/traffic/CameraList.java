...
public class CameraList extends ArrayList<CameraValueObject> {
	...
	public CameraList() {
		...
		add(30222320, -92052190, "Betrand @ Dulles Billeaud", "BertDullesBilleau");
		
		add(30244530, -92011760, "NB Evangeline Thruway @ Willow", "NBThwyWillow");
		add(30244750, -92013390, "SB Evangeline Thruway @ Willow", "SBThwyWillow");
		...
		add(30224550, -92010280, "SB Evangeline Thruway @ Johnston", "SBThwyJohn");
		add(30224920, -92009360, "NB Evangeline Thruway @ Louisiana", "NBThwyLou");
		add(30231130, -92013800, "SB Evangeline Thruway @ Simcoe", "SBThwySimc");
		add(30232980, -92012770, "NB Evangeline Thruway @ Mudd", "NBThwyMudd");
		add(30233190, -92014080, "SB Evangeline Thruway @ Mudd", "SBThwyMudd");
